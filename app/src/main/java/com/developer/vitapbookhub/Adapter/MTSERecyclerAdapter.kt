...
class MTSERecyclerAdapter(val context: Context, val itemList:List<Book>) : RecyclerView.Adapter<MTSERecyclerAdapter.MTSEViewHolder>(){
    class MTSEViewHolder(view: View): RecyclerView.ViewHolder(view){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MTSEViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_home_single_row,parent,false)

        return MTSEViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: MTSEViewHolder, position: Int)  {
