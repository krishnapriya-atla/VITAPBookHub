...
class QuantitativeRecyclerAdapter(val context: Context, val itemList:List<InterviewBook>) : RecyclerView.Adapter<QuantitativeRecyclerAdapter.QuantitativeViewHolder>() {
