...
class WebDevelopmentRecyclerAdapter(val context: Context, val itemList:List<InterviewBook>) : RecyclerView.Adapter<WebDevelopmentRecyclerAdapter.WebDevelopmentViewHolder>() {
