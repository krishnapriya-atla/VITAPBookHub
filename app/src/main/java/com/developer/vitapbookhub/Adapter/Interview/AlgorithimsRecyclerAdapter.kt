...
class AlgorithimsRecyclerAdapter(val context: Context, val itemList:List<InterviewBook>) : RecyclerView.Adapter<AlgorithimsRecyclerAdapter.AlgorithimsViewHolder>() {
