...
class NetworkingRecyclerAdapter(val context: Context, val itemList:List<InterviewBook>) : RecyclerView.Adapter<NetworkingRecyclerAdapter.NetworkingViewHolder>() {
